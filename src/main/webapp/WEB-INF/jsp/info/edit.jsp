    ...
    <div class="layui-body">
        ...
        <!-- 内容主体区域 -->
     	 <div class="manage" style="padding: 15px;">
			 <form class="layui-form" action="/info/edit_submit.do"  method="post">
			  ...
			  <input type="hidden" name="id" value="<c:out value="${info.id}" />" />
	            <div class="layui-form-item">
	                ...
	                <div class="layui-input-block">
	                    <input type="text" name="title" value="<c:out value="${info.title}" />" required lay-verify="required" placeholder="标题"
	            ...
	            <div class="layui-form-item layui-form-text">
	                ...
	                <div class="layui-input-block">
	                    <textarea id="content" name="content" style="width:700px;height:300px;"><c:out value="${info.content}" /></textarea>
	                </div>
	            </div>
